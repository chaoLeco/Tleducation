...
static NSString *const _cellIdentifierCollection = @"cell";
static NSString *const _footerIdentifierCollection = @"FooterView";
static NSString *const _identifierCollection = @"toolBarThumbCollectionViewCell";
...
- (UICollectionView *)toolBarThumbCollectionView{
    if (!_toolBarThumbCollectionView) {
        ...
        [toolBarThumbCollectionView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:_identifierCollection];
...
- (ZLPhotoPickerCollectionView *)collectionView{
    if (!_collectionView) {
        ...
        [collectionView registerClass:[ZLPhotoPickerCollectionViewCell class] forCellWithReuseIdentifier:_cellIdentifierCollection];
        // 底部的View
        [collectionView registerClass:[ZLPhotoPickerFooterCollectionReusableView class]  forSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:_footerIdentifierCollection];
...
- (void) pickerCollectionViewDidSelected:(ZLPhotoPickerCollectionView *) pickerCollectionView deleteAsset:(ZLPhotoAssets *)deleteAssets{
    ...
    if (self.selectPickerAssets.count || deleteAssets) {
        ...
        for (NSInteger i = 0; i < self.selectAssets.count; i++) {
            id objc = self.selectAssets[i];
            if ([objc isKindOfClass:[ZLPhotoAssets class]]) {
                ZLPhotoAssets *photoAsset = objc;
...
- (UICollectionViewCell *) collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UICollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:_identifierCollection forIndexPath:indexPath];
